...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "FGURiJhJ#zL3P961_x7wnTesZjNYBOWxGzbNT1Z-WzbjjRWYjq_c",
  // ADD Your Session Id 
  ...
  packname: process.env.packname || "ᴍᴀʟᴠɪɴ ᴛᴇᴄʜ",
...
//------------------------------------------------------------------------------------------------------------------
  ...
  START_MSG: process.env.START_MSG || `MALVIN-MD V2 Conected` ,

  ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/gdvaaw.jpg",
  MENU_IMG: process.env.MENU_IMG || "https://files.catbox.moe/gdvaaw.jpg",
